...
z_gal = np.linspace(z_m, z_M, nz_gal.shape[0])  # Redshift grid for galaxy distribution
dl_GW = np.linspace(dlm, dlM, nz_gal.shape[0])  # Luminosity distance grid for gravitational wave sources in Mpc
