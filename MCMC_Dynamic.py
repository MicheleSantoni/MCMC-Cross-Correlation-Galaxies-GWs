...
main_config = "DynBack" #DynBack #GW_det  # ET_Delta_2CE, ET_2L_2CE, ET_Delta, ET_2L, LVK
...
with myPool as pool:
    ...
    if not FLAGS.resume:
        ...
        print("Resuming from last point of the chain...") # the chains are on 2 different files
