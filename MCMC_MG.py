...
z_gal = np.linspace(z_m, z_M, 2500)  # Redshift grid for galaxy distribution
dl_GW = np.linspace(dlm, dlM, 2500)  # Luminosity distance grid for gravitational wave sources in Mpc
