...
class cosmo:
    ...
    def __init__(self, param_file=None, **kwargs):
        ...
        expansion_model = self.params.get("expansion_model", None)
        expansion_smg = self.params.get("expansion_smg", None)
        ...
        if expansion_model == "wowa":
            ...
            self.w0 = -1
            self.wa = 0
        #     print(f"Unsupported expansion_model: {expansion_model}")
    ...
    def hi_class_pk(self, k, z , nonlinear):
        ...
        """
        #print(self.params)
        self.params['z_max_pk'] = float(np.max(z)) + 0.1
        #if nonlinear:
        #    self.params['non_linear'] = 'Halofit' #mead2020
        ...
        #print('self.h',self.h)
        #print('k_out', k_out, len(k_out))
        #print('k_Mpc', k_Mpc,len(k_Mpc))
        ...
        pk_nl = cosmo.get_pk_all(k_Mpc, z_out, nonlinear = True, cdmbar = False, z_axis_in_k_arr = 0, interpolation_kind='cubic')
