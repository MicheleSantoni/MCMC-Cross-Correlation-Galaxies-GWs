...
/home/michele-santoni/Home_CPT/COLIBRI_GW/colibri/Extra.py
    ...
    def __init__(self, param_file=None, **kwargs):
        ...
        if expansion_model == "wowa":
            ...
            self.wa = 0
        #else:
        #    raise ValueError(f"Unsupported expansion_model: {expansion_model}")
    ...
    def hi_class_pk(self, k, z , nonlinear):
        ...
        #print(cosmo.get_pk_all.__doc__)
        ...
        pk_nl = cosmo.get_pk_all(k_Mpc, z_out,nonlinear=nonlinear ,interpolation_kind='cubic')
        ...
        return background, k_Mpc/self.h, z_out, pk_nl   # Pk shape (len(z), len(k))
