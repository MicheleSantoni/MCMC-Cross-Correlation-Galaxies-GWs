...
if __name__=='__main__':
	...
	if eftcamb_params['RPHbraiding_ODE0'] != 0:
		eftcamb_params['RPHbraiding_ODE0'] = -0.5 * eftcamb_params['RPHbraiding_ODE0']  # This maps the EFTCamb notation to the Bellini-Sawicki one 1404.3713
